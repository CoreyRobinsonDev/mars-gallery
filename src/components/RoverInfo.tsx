...
const RoverInfo: React.FC<Props> = ({ landing_date, launch_date, max_date, max_sol, name, status, total_photos, rover }) => { 
  const roverBio = {
    Curiosity: {
      img: <Image src='https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/PIA16239_High-Resolution_Self-Portrait_by_Curiosity_Rover_Arm_Camera.jpg/1200px-PIA16239_High-Resolution_Self-Portrait_by_Curiosity_Rover_Arm_Camera.jpg' alt='A self-portrait by the Curiosity rover arm camera.' />,
    ...
    Opportunity: {
      img: <Image src='http://www.nasa.gov/sites/default/files/thumbnails/image/oppty.jpg' alt="An artist's portrayal of Opportunity on the surface of Mars." />,
      bio: <><p><Span>Opportunity</Span>, also known as MER-B (Mars Exploration Rover – B) or MER-1, and nicknamed Oppy, is a robotic rover that was active on Mars from 2004 until mid-2018. <Span>Opportunity</Span> was operational on Mars for 5110 sols (5250 days, or 14 years, 136 days). Launched on July 7, 2003, as part of NASA's Mars Exploration Rover program, it landed in Meridiani Planum on January 25, 2004, three weeks after its twin <Span>Spirit</Span> (MER-A) touched down on the other side of the planet. With a planned 90-sol duration of activity (slightly less than 92.5 Earth days), <Span>Spirit</Span> functioned until it got stuck in 2009 and ceased communications in 2010, while <Span>Opportunity</Span> was able to stay operational for 5111 sols after landing, maintaining its power and key systems through continual recharging of its batteries using solar power, and hibernating during events such as dust storms to save power. This careful operation allowed <Span>Opportunity</Span> to operate for 57 times its designed lifespan, exceeding the initial plan by 14 years, 46 days (in Earth time). By June 10, 2018, when it last contacted NASA, the rover had traveled a distance of 45.16 kilometers (28.06 miles).</p><br/><p>Mission highlights included the initial 90-sol mission, finding meteorites such as Heat Shield Rock (Meridiani Planum meteorite), and over two years of exploring and studying Victoria crater. The rover survived moderate dust storms and in 2011 reached Endeavour crater, which has been described as a "second landing site." The <Span>Opportunity</Span> mission is considered one of NASA's most successful ventures.</p></>
    },
    Spirit: {
      img: <Image src='https://upload.wikimedia.org/wikipedia/commons/f/f8/KSC-03PD-0786.jpg' alt='The Mars Exploration Rover-2 (MER-2) during testing for mobility and maneuverability.' />,
